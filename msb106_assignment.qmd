...
Hypotesen vår antar at både befolkningsvekst og arbeidsledighetsrater vil følge bud-rente-teorien.
...
Samtidig forventes arbeidsledighetsraten å være relatert til tilgjengeligheten av høyere lønnede jobber og pendlingsmuligheter til sentrene.
...
Vi foreslår derfor at ved å inkludere romlige arbeidsledighetsforskjeller i vår analyse, kan vi bedre forstå hvordan slike regionale variabler kan påvirke befolkningsveksten i tråd med bud-rente-teorien.
**KILDE ARTIKKEL**
...
Her kan vi trekke inn Marton (1985) sin modell som støtter under hvorfor "Cities" kan ha høy arbeidsledighet med at fokuset ikke bare er på lønnssatsen, men også på hvordan arbeidere vurderer den totale nytten av å bo i en bestemt region.
**KILDE ARTIKKEL** Kategori 5 representerer regioner uten store økonomiske utfordringer med lav arbeisledighet, høy arbeidsvekt og høye boligpriser.
...
@fig-skandinavia viser den gjennomsnittlige befolkningsveksten i de skandinavi ske landene Danmark, Sverige og Norge i perioden 2002 til 2023 fordelt på de åtte forskjellige kategoriene i klassifiseringsmetodikken til Andersson, Håkonsen og Thorsen (2023).
...
Vi kan konkludere med at funnene i analysen bekrefter hypotesen om at befolkningsveksten i europeiske regioner endrer seg i tråd med bud-rente-teorien og at denne endringen også synes å være påvirket av regionale faktorer, slik som arbeidsledighet og fasiliteter @capello2016 **KILDE ARTIKKEL**
