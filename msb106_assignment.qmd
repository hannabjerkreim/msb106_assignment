...
Vi skal videre i oppgaven benytte oss av klassifiseringsmetodikken til @andersson. Klassifiseringen er basert på de tre kriteriene *arbeidsledighet* (U), *arbeidsvekst* (△E) og *huspris* (H).
...
@fig-stolpediagram visualiserer hvordan de ulike regionsinndelingene "Cities", "Towns/Suburbs" og "Rural areas" er fordelt på de åtte forskjellige kategoriene i klassifiseringsmetodikken av @andersson. Fra figuren ser vi at "cities"-regionene fordeler seg hovedsakelig på kategori 1, 3 og 5.
...
@fig-skandinavia viser den gjennomsnittlige befolkningsveksten i de skandinavi ske landene Danmark, Sverige og Norge i perioden 2002 til 2023 fordelt på de åtte forskjellige kategoriene i klassifiseringsmetodikken til @andersson.
